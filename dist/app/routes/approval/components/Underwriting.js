...
import {sizefont,Speedometerwidth,Speedometerheight,ColumnSpeedometerwidth,ColumnSpeedometerheight} from "../../../config/ConfigParam";
                  ...
                  <Tab eventKey="riskscoring" title={LanguageStore.translate('Risk Scoring')}>
                    <div className="sameline">
                     <div className="a50">
                         ...
                         <b>Odds:</b> {row.appentity.risklevel.odds}   <br/>
                         <b>Probability of Default:</b> {row.appentity.risklevel.probabilityofdefault}%   <br/>
                         <h1><b>{LanguageStore.translate('Decision Comments')}</b></h1>
                         <b>Scorecard Comments:</b> {row.appentity.scorecardcomments}    <br/>
                         <b>Rule Engine Comments:</b> {row.appentity.ruleenginecomments}    <br/>
